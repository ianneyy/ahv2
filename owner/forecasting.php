                            ...
                            <div class="drawer">
                                ...
                                <div class="drawer-side ">
                                    ...
                                    <ul class="menu  bg-[#ECF5E9] text-base-content min-h-full w-80 p-4 gap-3">
                                        ...
                                        <div>
                                            <button
                                                onclick="toggleDropdownSmall('cropsDropdownSmall', 'chevronIconSmall')"
            ...
            <div id="tab-yield">
                ...
                <div id="bulkModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
                    <div class="bg-white rounded-lg w-full max-w-5xl p-6 shadow-lg">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Add multiple rows below. Units auto-fill and are
                            read-only. Dates allowed: 2016 to today. Click <strong>Preview</strong> to validate
                            before import.</p>
