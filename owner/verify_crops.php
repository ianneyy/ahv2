        ...
        <div id="cropsDropdown" class="hidden ml-5  border-l border-gray-300">
          <div class="ml-3 mt-2 space-y-2">
            ...
            <a href="verify_crops.php"
              class="block px-4 py-2 text-sm rounded-lg hover:bg-[#BFF49B] text-[#28453E] bg-[#BFF49B] flex items-center gap-2">
            ...
            <div class="flex items-center gap-2 p-4 border-gray-200">
              ...
              <fieldset class="fieldset ">
                <select name="sort" class="hidden select ">
                  ...
                  <option value="qty_desc" <?= $sortOption === 'qty_desc' ? 'selected' : '' ?>>Quantity: High to Low
                  </option>
                ...
                <form method="POST" action="verify_crops.php">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="text-lg text-gray-500" id="approveLabel<?= $row['submissionid'] ?>">Approve Crop Submission
                      </h5>
                  ...
                  <input type="datetime-local" name="sellingdate" class="form-control" required min="<?= $minDateTime ?>"
                    ...
                    <div class="flex justify-end gap-4 mt-5">
                      <button onclick="document.getElementById('approveModal<?= $row['submissionid'] ?>').close()"
                        type="button" class="text-sm px-4 py-2 text-gray-400 hover:text-gray-600"
